...
export const EnterNamePage: FunctionComponent<EnterNamePageProps> = (props: EnterNamePageProps) => {
  return <Parent>
    <FlexHeader>
    ...
    <FlexBodyCenter>
      <FlexBody>
        ...
        <div>
          <FullWidthTextField label="Name" variant="outlined" /></div>
        <div><FullWidthTextField label="Surname" variant="outlined" /></div>
